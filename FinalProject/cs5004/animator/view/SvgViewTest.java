...
/**
 * This class represents tests for Svgview.
 */
public class SvgViewTest {
  ...
  /**
   * Constructs some instances for test.
   */
  @Before
  public void setUp() {
  ...
  /**
   * Tests invalid input of speed is negative.
   */
  ...
  /**
   * Tests invalid input of model is null.
   */
  @Test(expected = IllegalArgumentException.class)
  ...
  /**
   * Tests the view in string is right or not.
   */
  @Test
  ...
  /**
   * Tests the view in string of given buildings-txt input file is right or not.
   */
  @Test
  public void viewInStringOfBuildings() throws FileNotFoundException {

    String basicPath = new File("").getAbsolutePath();
    Readable readable = new FileReader(basicPath + "/testcase.txt");
