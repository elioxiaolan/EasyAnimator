...
/**
 * This class represents tests for controller.
 */
public class ControllerTest {
  ...
  /**
   * Tests the set up of the controller.
   */
  @Test
  ...
  /**
   * Tests the controller right or not when run animation of textview.
  ...
  /**
   * Tests the controller right or not when run animation of svgview.
   * @throws IOException when it is wrong
   */
  @Test
